...
//            awal:
   ...
   cout<<endl;
//            printf("\n\);
                cout<<"Masukkan Kode Pesawat [MEPATI/GARUDA/BATAVIA] : ";gets(kd_pesawat);
   cout<<"\nKelas Pesawat : "<<endl;
   ...
   if (strcmp(kd_pesawat,"MERPATI")== 0)
    {
     ...
     else if ( strcmp(kd_pesawat,"GARUDA")== 0)
    ...
    else if ( strcmp(kd_pesawat,"BATAVIA")== 0)
